        ...
        <div class="container">
            ...
            <form>
                ...
                <div class="mb-4">
                    ...
                    <textarea v-model="publication.description"  type="textarea" class="input__field" placeholder="Bruce Wayne" ></textarea>
                </div>
                <div class="mb-4">
                    <label class="input__label">Featured Image</label>
                    <input v-model="publication.featuredImage" type="text" class="input__field" placeholder="BruceWayne@gamil.com" />
                </div>
                <div class="mb-4 text-right">
                    <button class="w-full bg-yellow-dark text-yellow-darker font-semibold py-3 px-6 rounded " @click.prevent="save"></button>
                </div>
            </form>
        </div>
    </section>
