<template>
  <div class="default-layout">
    ...
    <modal :show="this.modals.login" @close-modal="closeModal">
      <h2>
        Wellcome to Platzi Rooms
      </h2>
      <form @submit.prevent="loginHandlerSubmit">
        <div class="mb-4">
          <label for="" class="input_lable">Email</label>
          <div class="form_field relative">
            <input v-model="formLogin.email" type="text" placeholder="bruce wyane@imnotbatman.org">
          </div>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          <toggle-input v-model="formLogin.rememberMe">Remember me.</toggle-input>
        </div>
        <div class="mb-4">
